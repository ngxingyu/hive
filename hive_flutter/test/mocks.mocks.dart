...
class _FakeHiveList<E extends _i3.HiveObject> extends _i1.Fake implements _i4.HiveList<E> {}
...
class MockBinaryReader extends _i1.Mock implements _i4.BinaryReader {
  ...
  @override
  void skip(int? bytes) => super.noSuchMethod(Invocation.method(
        #skip,
        [bytes],
      ));
  @override
  ...
  @override
  _i4.HiveList<_i3.HiveObject> readHiveList([
    int? length,
  ]) =>
      (super.noSuchMethod(
...
class MockBinaryWriter extends _i1.Mock implements _i4.BinaryWriter {
  @override
  void writeByte(int? byte) => super.noSuchMethod(Invocation.method(#writeByte, [byte]));
  @override
  void writeWord(int? value) => super.noSuchMethod(Invocation.method(#writeWord, [value]));
  @override
  void writeInt32(int? value) => super.noSuchMethod(Invocation.method(#writeInt32, [value]));
  @override
  void writeUint32(int? value) => super.noSuchMethod(Invocation.method(#writeUint32, [value]));
  @override
  void writeInt(int? value) => super.noSuchMethod(Invocation.method(#writeInt, [value]));
  @override
  void writeDouble(double? value) => super.noSuchMethod(Invocation.method(#writeDouble, [value]));
  @override
  void writeBool(bool? value) => super.noSuchMethod(Invocation.method(#writeBool, [value]));
  @override
  void writeString(String? value, {bool? writeByteCount = true, _i5.Converter<String, List<int>>? encoder = const _i5.Utf8Encoder()}) =>
      super.noSuchMethod(Invocation.method(#writeString, [value], {#writeByteCount: writeByteCount, #encoder: encoder}));
  @override
  void writeByteList(List<int>? bytes, {bool? writeLength = true}) =>
      super.noSuchMethod(Invocation.method(#writeByteList, [bytes], {#writeLength: writeLength}));
  @override
  void writeIntList(List<int>? list, {bool? writeLength = true}) =>
      super.noSuchMethod(Invocation.method(#writeIntList, [list], {#writeLength: writeLength}));
  @override
  void writeDoubleList(List<double>? list, {bool? writeLength = true}) =>
      super.noSuchMethod(Invocation.method(#writeDoubleList, [list], {#writeLength: writeLength}));
  @override
  void writeBoolList(List<bool>? list, {bool? writeLength = true}) =>
      super.noSuchMethod(Invocation.method(#writeBoolList, [list], {#writeLength: writeLength}));
  @override
  void writeStringList(List<String>? list, {bool? writeLength = true, _i5.Converter<String, List<int>>? encoder = const _i5.Utf8Encoder()}) =>
      super.noSuchMethod(Invocation.method(#writeStringList, [list], {#writeLength: writeLength, #encoder: encoder}));
  @override
  void writeList(List<dynamic>? list, {bool? writeLength = true}) =>
      super.noSuchMethod(Invocation.method(#writeList, [list], {#writeLength: writeLength}));
  @override
  void writeMap(Map<dynamic, dynamic>? map, {bool? writeLength = true}) =>
      super.noSuchMethod(Invocation.method(#writeMap, [map], {#writeLength: writeLength}));
  @override
  void writeHiveList(_i4.HiveList<_i3.HiveObject>? list, {bool? writeLength = true}) =>
      super.noSuchMethod(Invocation.method(#writeHiveList, [list], {#writeLength: writeLength}));
  @override
  void write<T>(T? value, {bool? writeTypeId = true}) => super.noSuchMethod(Invocation.method(#write, [value], {#writeTypeId: writeTypeId}));
}
